...
const ResultCard: React.FC<ResultCardProps> = ({
  ...
  return (
    ...
    >
      {/* ── Content + side rail; the rail spans the full card height (expanded panel
           included) so badges + type icon always sit on the card's last row ── */}
      <div className="plib-flex plib-gap-3">
        ...
        {/* ── Side rail: expand arrow on top; custody badges + type icon pinned to the card's last row ── */}
        <div
          className="plib-flex plib-flex-col plib-items-end plib-justify-end plib-flex-shrink-0 plib-cursor-pointer"
          onClick={handleClick}
        >
          {hasExpandableFields && (
            <button
