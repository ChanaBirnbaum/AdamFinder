...
const BADGE_STYLES: Record<BadgeStatus, { className: string; label: string }> = {
  active: { className: 'bg-[#f6fff8] border-[0.5px] border-[#2e7d32] text-[#2e7d32]', label: 'פעיל'  },
  future: { className: 'bg-[#fff9f0] border-[0.5px] border-[#ef6c00] text-[#ef6c00]', label: 'עתידי' },
  past:   { className: 'bg-[#fafafa] border border-[#6b7280] text-[#6b7280]',          label: 'עבר'   },
};
